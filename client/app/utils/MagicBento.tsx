...
const BentoCardGrid: React.FC<{
  ...
  <div
    className="bento-section grid gap-4 p-3 w-full max-w-full select-none relative"
      ...
      <style>
        {`
          ...
          .card--border-glow:hover {
            box-shadow: 0 4px 20px rgba(2, 44, 30, 0.4), 0 0 30px rgba(${glowColor}, 0.15);
          }
