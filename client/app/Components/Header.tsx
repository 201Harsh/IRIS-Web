...
const Header = () => {
  ...
  return (
    <>
      <div
        ref={headerRef}
        className="fixed top-8 left-1/2 -translate-x-1/2 w-[90%] md:w-[85%] lg:w-[65%] px-5 py-5 flex justify-between items-center bg-black/40 backdrop-blur-lg z-100 border border-[#10b981]/20 rounded-full text-white shadow-[0_4px_30px_rgba(16,185,129,0.15)]"
      >
        <Link href="/">
